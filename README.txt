Koden är skriven så att den kommer köra GUI så fort du kör programmet och efter det så är det väldigt självförklarat.
För att hitta statistiken så är det bara att klicka på knappen File och Show stats.
Knappen Show previous games öppnar mappen där programmen har sparat tidigare spel och därinne så visas varje spelat spel med datum och tid då den spelades.
